...
Here you'll find the code I wrote, how to build and install it and many other details. The hardware project is on https://hackaday.io/project/197097-esphome-programming-a-very-cheap-power-meter
